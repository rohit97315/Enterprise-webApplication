...
import { sendEmployeeChatMessage } from '../services/auth.api';

const EmployeeAssistantView = () => {
    ...
    const handleSendMessage = async (e) => {
        ...
        try {
            const data = await sendEmployeeChatMessage(message);
    ...
    return (
        <div className="max-w-250 my-12 mx-auto p-5 border border-zinc-200 rounded-lg shadow-sm bg-zinc-900/50">
            <h3 className="text-xl font-bold text-zinc-100">HR Assistant</h3>
            <p className='font-medium text-zinc-400 mb-4'>Ask about leave balance, or apply for leave directly in chat.</p>
            ...
            <form onSubmit={handleSendMessage} className="flex gap-2">
                <input
                    ...
                    placeholder="e.g. Apply sick leave from July 10 to July 12"
...
export default EmployeeAssistantView;